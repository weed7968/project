            ...
            <div className="v30_48">
                <div className="v34_74">
                    ...
                    <div className="v34">
                        ...
                        <div className="v34_42">{main} 어떠세요?{j1}{j2}{j3}</div>
                    </div>
                    
                    <div className="v34_45"
                    onClick={clickYes}>예</div>

                    <div className="v34_47"
                    onClick={clickNo}>아니요</div>

                    <div className="v34_51"
                    onClick={clickMollu}>모르겠습니다</div>

                    <div className={back}
                    onClick={clickBack}>이전 질문</div>
                </div>
            </div>
        );
